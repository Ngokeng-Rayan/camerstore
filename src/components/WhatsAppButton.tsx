...
export function WhatsAppButton({ productName, price }: WhatsAppButtonProps = {}) {
  ...
  return (
    <a
      ...
      className="fixed bottom-28 md:bottom-8 right-4 md:right-8 z-[999] flex items-center gap-2 bg-[#25D366] hover:bg-[#1ebe5d] text-white font-bold rounded-full shadow-[0_8px_30px_rgb(37,211,102,0.4)] transition-all duration-300 hover:scale-110 active:scale-95 group border-2 border-white/20"
    >
      {/* Icône WhatsApp SVG */}
      <div className="w-16 h-16 flex items-center justify-center flex-shrink-0 relative">
        {/* Effet d'onde derrière l'icône */}
        <div className="absolute inset-0 rounded-full bg-[#25D366] animate-ping opacity-20"></div>
        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 fill-white relative z-10">
